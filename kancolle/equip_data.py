...
EQTDATA = {
	game_utils.EQTYPE_MAINGUNS: {
		'name': 'Main Gun (S)',
		'image': 1,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
		'improve': {'Pshell':1,'Pnb':1,'ACCshell':1,'ACCnb':1.3},
		'canequip': ['DD','CL','CT','CLT','AS','AV','AO','AR','LHA','DE'],
		'canequipS': [541]
	},
	game_utils.EQTYPE_MAINGUNSAA: {
		'name': 'Main Gun (S)',
		'image': 16,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_HAGUN,
		'improve': {'Pshell':1,'Pnb':1,'ACCshell':1,'ACCnb':1.3,'AAfleet':2,'AAself':1},
		'canequip': ['DD','CL','CT','CLT','AS','AV','AO','AR','LHA','DE'],
		'canequipS': [541]
	},
	game_utils.EQTYPE_MAINGUNM: {
		'name': 'Main Gun (M)',
		'image': 2,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
	...
	game_utils.EQTYPE_SECGUN: {
		'name': 'Secondary Gun',
		'image': 4,
		'btype': game_utils.EQ_B_SECGUN,
		'atype': game_utils.EQ_A_GUN,
		'improve': {'Pshell':1,'Pnb':1,'ACCshell':1,'ACCnb':1.3},
	...
	game_utils.EQTYPE_APSHELL: {
		'name': 'AP Shell',
		'image': 13,
		'btype': game_utils.EQ_B_APSHELL,
		'improve': {'Pshell':1,'Pnb':1,'ACCshell':1,'ACCnb':1.3},
		'canequip': ['FBB','BB','BBV'],
	},
	game_utils.EQTYPE_TORPEDO: {
		'name': 'Torpedo',
		'image': 5,
		'btype': game_utils.EQ_B_TORPEDO,
		'improve': {'Ptorp':1.2,'Pnb':1,'ACCtorp':2,'ACCnb':1.3},
		'canequip': ['DD','CL','CT','CLT','CA','CAV','SS','SSV'],
		'canequipS': [178],
	},
	game_utils.EQTYPE_TORPEDOSS: {
		'name': 'Torpedo',
		'image': 5,
		'btype': game_utils.EQ_B_TORPEDO,
		'canequip': ['SS','SSV'],
	},
	game_utils.EQTYPE_MIDGETSUB: {
		'name': 'Midget Sub',
		'image': 5,
	...
	game_utils.EQTYPE_SEAPLANE: {
		'name': 'Recon Seaplane',
		'image': 10,
		'btype': game_utils.EQ_B_RECON,
		'improve': {'LOS':1.2},
	...
	game_utils.EQTYPE_SEAPLANEBOMBER: {
	...
	game_utils.EQTYPE_CARRIERSCOUT: {
		'name': 'Scout Plane',
		'image': 9,
		'canequip': ['CVL','CV','CVB','LandBase'],
		'canequipS': [553],
	...
	game_utils.EQTYPE_CARRIERSCOUT2: {
		'name': 'Scout Plane',
		'image': 9,
		'improve': {'LOS':1.2},
	...
	game_utils.EQTYPE_ASWPLANE: {
		'name': 'Anti-Sub Plane',
		'image': 22,
		'canequip': ['CVL','LHA'],
		'canequipS': [199, 418, 468, 553],
		'cannotequipS': [521, 526],
		'isPlane': True,
	},
	game_utils.EQTYPE_RADARS: {
		'name': 'Radar (S)',
		'image': 11,
		'btype': game_utils.EQ_B_RADAR,
		'improve': {'LOS':1.25},
		'canequip': ['DD','CL','CT','CLT','CA','CAV','FBB','BB','BBV','CVL','CV','CVB','AS','AV','AO','AR','LHA','DE'],
	},
	game_utils.EQTYPE_RADARL: {
		'name': 'Radar (L)',
		'image': 11,
		'btype': game_utils.EQ_B_RADAR,
		'improve': {'LOS':1.4},
	...
	game_utils.EQTYPE_RADARXL: {
		'name': 'Radar (L)',
		'image': 11,
		'btype': game_utils.EQ_B_RADAR,
		'canequip': ['FBB','BB','BBV'],
	},
	game_utils.EQTYPE_ENGINE: {
		'name': 'Engine',
		'image': 19,
		'canequip': ['DD','CL','CT','CLT','CA','CAV','FBB','BB','BBV','CVL','CV','CVB','SS','SSV','AS','AV','AO','AR','LHA'],
	},
	game_utils.EQTYPE_TYPE3SHELL: {
		'name': 'Anti-Air Shell',
		'image': 12,
		'atype': game_utils.EQ_A_TYPE3SHELL,
		'canequip': ['CA','CAV','FBB','BB','BBV'],
	},
	game_utils.EQTYPE_BULGEM: {
		'name': 'Torpedo Bulge',
		'image': 23,
		'improve': {'AR':.7},
	...
	game_utils.EQTYPE_SEARCHLIGHTL: {
		'name': 'Night Equip',
		'image': 24,
		'improve': {'Pshell':1,'Pnb':1,'ACCshell':1,'ACCnb':1.3},
		'canequip': ['FBB','BB','BBV'],
	...
	game_utils.EQTYPE_SRF: {
		'name': 'Misc',
		'image': 26,
		'canequip': ['AR'],
	},
	game_utils.EQTYPE_FCF: {
		'name': 'Misc',
		'image': 28,
	...
	game_utils.EQTYPE_REPAIR: {
		'name': 'Misc',
		'image': 14,
		'canequip': ['DD','CL','CT','CLT','CA','CAV','FBB','BB','BBV','CVL','CV','CVB','SS','SSV','AS','AV','AO','AR','LHA','DE'],
	},
	game_utils.EQTYPE_RATION: {
		'name': 'Misc',
		'image': 34,
		'canequip': ['DD','CL','CT','CLT','CA','CAV','FBB','BB','BBV','CVL','CV','CVB','SS','SSV','AS','AV','AO','AR','LHA','DE'],
	},
	game_utils.EQTYPE_SEAPLANEFIGHTER: {
	...
	game_utils.EQTYPE_LANDINGTANK: {
		'name': 'Misc',
		'image': 36,
		'btype': game_utils.EQ_B_LC3,
	...
	game_utils.EQTYPE_OILDRUM: {
		'name': 'Misc',
		'image': 35,
		'canequip': ['AO'],
	},
	game_utils.EQTYPE_LANDBOMBER: {
		'name': 'Misc',
		'image': 37,
		'canequip': ['LandBase'],
		'isPlane': True,
...
EQDATA = {
	...
	1: {
		...
		'nameJP': '12cm単装砲',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_MAINGUNS,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
		'FP': 1,
		'AA': 1,
	...
	3: {
		...
		'nameJP': '10cm連装高角砲',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_MAINGUNSAA,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_HAGUN,
		'FP': 2,
		'AA': 7,
	...
	4: {
		...
		'nameJP': '14cm単装砲',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_MAINGUNM,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
		'improvetype': 1,
		'fitclass': 101,
	...
	7: {
		...
		'nameJP': '35.6cm連装砲',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_MAINGUNL,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
		'improvetype': 1,
		'fitclass': 1,
	...
	10: {
		...
		'nameJP': '12.7cm連装高角砲',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_SECGUNAA,
		'btype': game_utils.EQ_B_SECGUN,
		'atype': game_utils.EQ_A_HAGUN,
		'FP': 2,
		'AA': 4,
	...
	13: {
		...
		'nameJP': '61cm三連装魚雷',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_TORPEDO,
		'btype': game_utils.EQ_B_TORPEDO,
		'improvetype': 1,
		'TP': 5,
		'RNG': 1
	...
	16: {
		...
		'nameJP': '九七式艦攻',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_TORPBOMBER,
		'improvetype': 2,
		'TP': 5,
		'ASW': 4,
		'LOS': 1
	...
	19: {
		...
		'nameJP': '九六式艦戦',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_FIGHTER,
		'improvetype': 2,
		'AA': 2
	},
	20: {
	...
	23: {
		...
		'nameJP': '九九式艦爆',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_DIVEBOMBER,
		'improvetype': 2,
		'ASW': 3,
		'DIVEBOMB': 5
	},
	...
	25: {
		...
		'nameJP': '零式水上偵察機',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_SEAPLANE,
		'btype': game_utils.EQ_B_RECON,
		'improvetype': 2,
		'AA': 1,
		'ASW': 2,
	...
	26: {
		...
		'added': '2013-04-17',
		'b_image': 11,
		'type': game_utils.EQTYPE_SEAPLANEBOMBER,
		'btype': game_utils.EQ_B_RECON,
		'improvetype': 2,
		'AA': 2,
		'ASW': 4,
	...
	27: {
		...
		'nameJP': '13号対空電探',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_RADARS,
		'btype': game_utils.EQ_B_RADAR,
		'atype': game_utils.EQ_A_AIRRADAR,
		'improvetype': 1,
		'AA': 2,
		'LOS': 3,
		'ACC': 1
	...
	35: {
		...
		'nameJP': '三式弾',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_TYPE3SHELL,
		'btype': game_utils.EQ_B_TYPE3SHELL,
		'atype': game_utils.EQ_A_TYPE3SHELL,
		'AA': 5
	},
	36: {
		...
		'nameJP': '九一式徹甲弾',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_APSHELL,
		'btype': game_utils.EQ_B_APSHELL,
		'improvetype': 1,
		'FP': 8,
		'ACC': 1
	...
	41: {
		...
		'nameJP': '甲標的',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_MIDGETSUB,
		'TP': 12
	},
	42: {
		'name': 'Repair Team',
	...
	44: {
		...
		'nameJP': '九四式爆雷投射機',
		'added': '2013-04-17',
		'type': game_utils.EQTYPE_DEPTHCHARGE,
		'btype': game_utils.EQ_B_DEPTHCHARGE,
		'improvetype': 1,
		'ASW': 5
	},
	...
	54: {
		...
		'nameJP': '彩雲',
		'added': '2013-05-17',
		'type': game_utils.EQTYPE_CARRIERSCOUT,
		'improvetype': 2,
		'noRedT': True,
		'LOS': 9,
		'ACC': 2
	...
	68: {
		...
		'nameJP': '大発動艇',
		'added': '2013-12-24',
		'type': game_utils.EQTYPE_LANDINGCRAFT,
		'btype': game_utils.EQ_B_LC1,
		'improvetype': 1,
	},
	69: {
		...
		'nameJP': 'カ号観測機',
		'added': '2013-12-24',
		'type': game_utils.EQTYPE_AUTOGYRO,
		'ASW': 9,
		'ACC': 1
	},
	70: {
		...
		'nameJP': '三式指揮連絡機(対潜)',
		'added': '2013-12-24',
		'type': game_utils.EQTYPE_ASWPLANE,
		'ASW': 7,
		'LOS': 1,
		'ACC': 2
	},
	...
	74: {
		...
		'nameJP': '探照灯',
		'added': '2014-02-26',
		'type': game_utils.EQTYPE_SEARCHLIGHTS,
		'improvetype': 1,
		'LOS': 2
	},
	75: {
	...
	95: {
		...
		'added': '2014-06-06',
		'type': game_utils.EQTYPE_TORPEDOSS,
		'btype': game_utils.EQ_B_TORPEDO,
		'TP': 16,
		'RNG': 1,
		'ACC': 3
	...
	101: {
		...
		'nameJP': '照明弾',
		'added': '2014-06-06',
		'type': game_utils.EQTYPE_STARSHELL
	},
	102: {
	...
	128: {
		...
		'nameJP': '試製51cm連装砲',
		'added': '2015-02-06',
		'type': game_utils.EQTYPE_MAINGUNXL,
		'btype': game_utils.EQ_B_MAINGUN,
		'atype': game_utils.EQ_A_GUN,
		'improvetype': 1,
		'fitclass': 7,
	...
	138: {
		...
		'nameJP': '二式大艇',
		'added': '2015-04-28',
		'type': game_utils.EQTYPE_FLYINGBOAT,
		'btype': game_utils.EQ_B_RECON,
		'improvetype': 2,
		'ASW': 1,
		'LOS': 12,
	...
	140: {
		...
		'nameJP': '96式150cm探照灯',
		'added': '2015-05-29',
		'type': game_utils.EQTYPE_SEARCHLIGHTL,
		'improvetype': 1,
		'AA': 1,
		'LOS': 3
	},
	...
	142: {
		...
		'added': '2015-07-21',
		'type': game_utils.EQTYPE_RADARXL,
		'btype': game_utils.EQ_B_RADAR,
		'FP': 1,
		'AA': 8,
		'AR': 1,
	...
	145: {
		...
		'nameJP': '戦闘糧食',
		'added': '2015-08-10',
		'type': game_utils.EQTYPE_RATION
	},
	146: {
		'name': 'Underway Replenishment',
		'nameJP': '洋上補給',
		'added': '2015-08-10',
		'type': game_utils.EQTYPE_OILDRUM,
		'AR': -2
	},
	147: {
	...
	151: {
		...
		'nameJP': '試製景雲(艦偵型)',
		'added': '2015-10-21',
		'type': game_utils.EQTYPE_CARRIERSCOUT2,
		'FP': 2,
		'ACC': 2,
		'LOS': 11
	},
	...
	154: {
		...
		'added': '2015-10-30',
		'type': game_utils.EQTYPE_DIVEBOMBER,
		'btype': game_utils.EQ_B_NIGHTBOMBER2,
		'improvetype': 2,
		'DIVEBOMB': 4,
		'AA': 7,
		'ACC': 1,
	...
	164: {
		...
		'added': '2016-02-10',
		'b_image': 12,
		'type': game_utils.EQTYPE_SEAPLANEFIGHTER,
		'improvetype': 2,
		'DIVEBOMB': 1,
		'AA': 2,
		'ASW': 1,
	...
	167: {
		...
		'nameJP': '特二式内火艇',
		'added': '2016-03-19',
		'type': game_utils.EQTYPE_LANDINGTANK,
		'btype': game_utils.EQ_B_LC3,
		'improvetype': 1,
	},
	168: {
		...
		'added': '2016-04-25',
		'b_image': 13,
		'type': game_utils.EQTYPE_LANDBOMBER,
		'DIVEBOMB': 10,
		'TP': 8,
		'AA': 1,
		'ASW': 2,
	...
	175: {
		...
		'added': '2016-05-02',
		'b_image': 13,
		'type': game_utils.EQTYPE_INTERCEPTOR,
		'AA': 6,
		'ACC': 5,
		'EV': 2
	},
	...
	199: {
		...
		'added': '2016-12-09',
		'b_image': 14,
		'type': game_utils.EQTYPE_JETBOMBER,
		'isjet': True,
		'DIVEBOMB': 15,
		'AA': 6,
		'ACC': 1,
	...
	209: {
		...
		'nameJP': '彩雲(輸送用分解済)',
		'added': '2017-02-12',
		'type': game_utils.EQTYPE_TRANSPORTITEM,
	},
	210: {
		'name': 'Submarine Radar & Waterproof Telescope',
		'nameJP': '潜水艦搭載電探&水防式望遠鏡',
		'added': '2017-02-11',
		'type': game_utils.EQTYPE_SUBRADAR,
		'FP': 1,
		'AA': 1,
		'ACC': 2,
		'EV': 8,
	...
	226: {
		...
		'added': '2017-05-02',
		'type': game_utils.EQTYPE_DEPTHCHARGE,
		'btype': game_utils.EQ_B_DEPTHCHARGE2,
		'ASW': 4,
	},
	227: {
	...
	254: {
		...
		'added': '2017-09-12',
		'type': game_utils.EQTYPE_FIGHTER,
		'btype': game_utils.EQ_B_NIGHTFIGHTER,
		'AA': 8,
		'ACC': 2,
		'EV': 3,
		'ASW': 4,
	...
	257: {
		...
		'added': '2017-09-12',
		'type': game_utils.EQTYPE_TORPBOMBER,
		'btype': game_utils.EQ_B_NIGHTBOMBER,
		'FP': 2,
		'TP': 9,
		'AA': 1,
		'ACC': 2,
	...
	258: {
		...
		'added': '2017-09-12',
		'type': game_utils.EQTYPE_SCAMP,
		'btype': game_utils.EQ_B_NIGHTCREW,
		'FP': 1,
		'AR': 1,
		'RNG': 2,
	},
